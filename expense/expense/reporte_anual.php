            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <table id="example" class="table table-striped " style="width:100%">
                        ...
                        $sql = "SELECT year(expenseDate) as rptyear,SUM(expenseDate) as totalyear FROM expense where (itemCost BETWEEN '$fdate' and '$tdate') && (userId='$userId') group by year(expenseDate)";
