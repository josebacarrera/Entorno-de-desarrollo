                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="example" class="table table-striped " style="width:100%">
                                    ...
                                    $sql = "SELECT month(expenseDate) as rptmonth,year(expenseDate) as rptyear,SUM(itemCost) as totalmonth FROM expense  where (itemCost BETWEEN '$fdate' and '$tdate') && (userId='$userId') group by month(expenseDate),year(expenseDate)";
